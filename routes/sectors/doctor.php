...
return [
    ...
    ['POST', '/doctor/appointments/configure/create', [AppointmentController::class, 'createAvailability'], 'doctor.appointments.configure.create', ['doctor']],
    ['POST', '/doctor/appointments/configure/{id}/disable', [AppointmentController::class, 'disableAvailability'], 'doctor.appointments.configure.disable', ['doctor']],
    ['POST', '/doctor/appointments/configure/{id}/enable', [AppointmentController::class, 'enableAvailability'], 'doctor.appointments.configure.enable', ['doctor']],
