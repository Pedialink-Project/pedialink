...
return [
    ...
    ['POST', '/phm/maternal-profiles/{id}/health-records/edit', [maternalhealthrecordController::class, 'editMaternalRecord'], 'phm.maternal.health.edit', ['phm']],
    ['POST', '/phm/maternal-profiles/{id}/health-records/delete', [maternalhealthrecordController::class, 'deleteMaternalRecord'], 'phm.maternal.health.delete', ['phm']],
