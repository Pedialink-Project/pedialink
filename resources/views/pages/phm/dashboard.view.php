                ...
                <div class="row appoinment">
                    <div class="primary-details">
                        ...
                        <div class="sub-details">
                            ...
                            <div class="sub-name">Dr {{ $appointment['doctor_name'] }}</div>
                        </div>
                    </div>
        ...
        <c-card class="card vaccine-card">
            <div class="header">
                <div class="title-section">
                    ...
                    <span class="card-subtitle">Vaccines due for accessible children</span>
                </div>
            </div>
            ...
            <div class="card-body">
                 @if (count($vaccinations) <= 0)
                    <c-emptycard
                        ...
                        description="There are no scheduled vaccinations for accessible children."
                    />
                @endif
                ...
                @foreach ($vaccinations as $vaccination)
                    ...
                    <div class="row vaccine-row">
                        <div class="primary-details">
                            <div class="name">{{ $vaccination['child_name'] }}</div>
                            <div class="sub-details">
                                <!-- Location Icon -->
                                ...
                                <div class="sub-name">MOH Clinic</div>
                            </div>
                        </div>
                        <!-- Vaccine Type -->
                        <c-badge type="blue">{{ $vaccination['vaccine_code'] }}</c-badge>
