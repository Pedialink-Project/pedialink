                                ...
                                <c-slot name="menu">
                                    ...
                                    @if($appointment['status'] == 'confirmed' || $appointment['status'] == 'pending')
                                        <c-modal id="cancel-appointment-{{$key}}" size="md" :initOpen="flash('cancelAppointment') == $appointment['id'] ? true : false">
                                            ...
                                            <div class="msg">
                                                Are you sure you want to cancel the appointment for <strong>{{ $appointment['maternal']['name'] }}</strong>? This action cannot be undone.
                                            </div>



                                            <form id="cancel-appointment-form-{{ $key }}" action="{{route('parent.appointment.cancel', ['id' => $appointment['id']])}}" method="POST" novalidate>
