    ...
    <div class="left-col">
        ...
        <c-card class="card vaccine-card">
            ...
            <div class="card-body">
                ...
                <c-emptycard
                    ...
                    description="There are no upcoming vaccinations for your children." />
                @endif
        ...
        <c-card class="card appoinment-card">
            <div class="header">
                ...
                <c-link type="secondary" href="{{route('parent.appointments.child')}}">View All</c-link>
            </div>
            <hr class="divider">
            <div class="card-body">
                ...
                <div class="row appoinment">
                    <div class="primary-details">
                        <div class="name">{{$childAppointment['child']['name']}} <span>Appointment</span></div>
                        @if($childAppointment['doctor'])
                        <div class="sub-details">
                            <!-- Doctor Icon -->
                            ...
                            <div class="sub-name">{{'Dr. '.$childAppointment['doctor']['name']}}</div>
                        </div>
                        @endif
                    </div>
                    <div class="secondary-deatails">
                        <div class="date">{{$childAppointment['slot_date']}}</div>
                        <c-badge type="primary">{{$childAppointment['start_time']}}</c-badge>
                    </div>
                </div>
        ...
        <c-card class="card appoinment-card">
            <div class="header">
                ...
                <c-link type="secondary" href="{{route('parent.appointments.my')}}">View All</c-link>
            </div>
            <hr class="divider">
            <div class="card-body">
                ...
                <div class="row appoinment">
                    <div class="primary-details">
                        ...
                        <div class="sub-details">
                            ...
                            <div class="sub-name">{{'Dr. '.$maternalAppointment['doctor']['name']}}</div>
                        </div>
                        @endif
                    </div>
                    <div class="secondary-deatails">
                        <div class="date">{{$maternalAppointment['slot_date']}}</div>
                        <c-badge type="primary">{{$maternalAppointment['start_time']}}</c-badge>
                    </div>
                </div>
        ...
        <c-card class="card event-card">
            <div class="header">
                <div class="title-section">
                    ...
                    <span class="card-subtitle">Scheduled health events and campaigns</span>
                </div>
                <c-link type="secondary" href="{{route('parent.events.campaigns')}}">View All</c-link>
            </div>
            <hr class="divider">
                ...
                <div class="row event">
                    <div class="primary-details">
                        ...
                        <div class="sub-details">
                            ...
                            <div class="sub-name">{{$event['event_date']}} at {{date('h.i A', strtotime($event['start_time']))}}</div>
                        </div>
                        <div class="sub-details">
                            <!-- Participants Icon-->
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                            ...
                            <div class="sub-name">{{$event['participants_count']}} Participants</div>
                            <!-- Location Icon -->
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <div class="sub-name">{{$event['event_location']}}</div>
                        </div>
                    </div>
                    <div class="secondary-deatails">
