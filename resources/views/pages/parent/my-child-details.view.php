    ...
    <div class="left-col">
            ...
            <div class="card-body">
                @if(count($vaccinations) === 0)
                    <c-emptycard
                        ...
                        description="There are no vaccination records available for this child yet."
                    />
                @endif
        ...
        <c-card class="card height-card">
            <div class="header">
                ...
                <c-link type="secondary" href="{{route('parent.growth.tracking')}}">View All</c-link>
            ...
            <div class="card-body">
                ...
                <div class="height-no-data" style="display:none;">
                    <c-emptycard
                        title="No height records"
                        description="There are no height records available for this child yet."
                    />
                </div>
            </div>
        </c-card>
    ...
    <div class="right-col">
        <c-card class="card appoinment-card">
            ...
            <div class="card-body">
                ...
                @if(count($appointments) === 0)
                    <c-emptycard
                        title="No appoinments scheduled"
                        description="There are no upcoming appoinments for this child."
                    />
                @endif
                ...
                @foreach($appointments as $key => $appointment)
                    <div class="row appoinment">
                        <div class="primary-details">
                            <div class="name">{{ $appointment['reason'] }}</div>
                            <div class="sub-details">
                                <!--Doctor Icon-->
                        ...
                        <div class="secondary-details">
                            <div class="date">{{$appointment['slot_date']}}</div>
                            <c-badge type="primary">{{ $appointment['start_time'] }}</c-badge>
                        </div>
        ...
        <c-card class="card bmi-card">
            ...
            <div class="card-body">
                ...
                <div class="bmi-no-data" style="display:none;">
                    <c-emptycard
                        title="No BMI records"
                        description="There are no BMI records available for this child yet."
                    />
                </div>
            </div>
        </c-card>
        ...
        <c-card class="card weight-card">
            ...
            <div class="card-body">
                ...
                <div class="weight-no-data" style="display:none;">
                    <c-emptycard
                        title="No weight records"
                        description="There are no weight records available for this child yet."
                    />
                </div>
            </div>
        </c-card>
