    ...
    <c-table.controls :filters="['status' => ['active', 'inactive']]" action="{{ route('doctor.appointments.configure')}}">
        ...
        <c-slot name="extrabtn">
            <c-modal id="add-configure-modal" size="sm" :initOpen="flash('add') ? true : false">
                ...
                <form id="add-weekday" class="weekday-form" method="POST" action="{{ route("doctor.appointments.configure.create") }}">
                    <c-select
                        name="weekday"
                    ...
                    >
                        @foreach ($availableWeekdays as $weekday)
                            <li class="select-item" data-value="{{ $weekday['value'] }}">{{ $weekday['name'] }}</li>
                        @endforeach
                    </c-select>
                    <c-input
                        type="time"
