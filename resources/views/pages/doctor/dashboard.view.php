                         ...
                         <!-- Single appointment row  -->
                            <div class="row appoinment">
                                <div class="primary-details">
                                    <div class="name">{{ $appointment['child_name'] ?? 'Unknown' }} - <span>{{ $appointment['reason'] ?? 'Unknown' }}</span></div>
                                    <div class="sub-details">
                                        ...
                                        <div class="sub-name">Dr.{{ $appointment['doctor_name'] ?? 'Unknown' }}</div>
                                    </div>
                                </div>
                                <div class="secondary-deatails">
                                    <div class="date">{{ $appointment['slot_date'] ?? 'Unknown' }}</div>
                                    <c-badge type="primary">{{ $appointment['start_time'] ?? 'Unknown' }}</c-badge>
                                </div>
                            </div>
                @endforeach
            </div>
    ...
    <div class="right-col">
        ...
        <c-card class="card appoinment-card">
            ...
            <div class="card-body">
                ...
                @foreach ($latestHealthRecords as $healthRecords)
                    <!-- Single appointment row  -->
                    <div class="row appoinment">
                        <div class="primary-details">
                            <div class="name">{{ $healthRecords['patient']['name'] ?? 'N/A' }}</div>
                            <div class="sub-details">
                                <!-- Doctor Icon -->
                                <svg width="17" height="17" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="sub-name">{{ $healthRecords['type'] ?? 'N/A' }}</div>
                            </div>
                        </div>
                        <div class="secondary-deatails">
                            <c-link type="secondary" href="{{ $healthRecords['type'] === 'Child' ? route('doctor.child.health', ['id' => $healthRecords['patient']['id']]) : route('doctor.maternal.health', ['id' => $healthRecords['patient']['id']]) }}">
                                View Records
                            </c-link>
                        </div>
                    </div>
